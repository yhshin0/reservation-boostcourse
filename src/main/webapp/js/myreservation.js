...
GetReservations.prototype = {
	...
	registerEvents : function() {
		...
		// 리뷰남기기 버튼 이벤트 등록
		document.querySelectorAll("div.wrap_mylist > ul > li:nth-child(2) div.booking_cancel>button.btn").forEach(function(obj) {
			obj.addEventListener("click", function() {
				var reservationInfoId = obj.closest("div.card_detail").firstElementChild.innerText.substr(3);
				var productId = obj.closest("div.card_body").firstElementChild.value;
