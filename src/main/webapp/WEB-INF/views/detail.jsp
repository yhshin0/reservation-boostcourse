...
<body>
          ...
          <c:choose>
            <c:when test="${reservationEmail ne null }">
				...
				<div class="section_review_list">
					...
					<a class="btn_review_more" href="review?displayInfoId=${displayInfoId}">
				...
				<div class="section_info_tab">
					...
					<ul class="info_tab_lst">
						<li class="item active _detail">
							<a class="anchor active"> <span>상세정보</span>
							</a>
						</li>
						<li class="item _path">
							<a class="anchor"> <span>오시는길</span>
							</a>
						</li>
					</ul>
					<!-- [D] 상세정보 외 다른 탭 선택 시 detail_area_wrap에 hide 추가 -->
					<!-- start detail tab content -->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/handlebars.js/4.0.12/handlebars.min.js"></script>
	...
	<script type="rv-template" id="averageGrade">
		<span class="graph_mask"> <em class="graph_value" style="width: {{percentWidth}}%;"></em> </span>
		<strong class="text_value"> <span>{{averageScore}}</span> <em class="total">5.0</em> </strong>
		<span class="join_count"><em class="green">{{reviewCount}}건</em> 등록</span>
	</script>
			...
			<div>
				<div class="review_area">
					<div class="thumb_area">
						{{#if reviewImage}}
						<a href="download?filePath={{reviewImage}}" class="thumb" title="이미지 크게 보기"> <img width="90" height="90" class="img_vertical_top" src="{{reviewImage}}" alt="리뷰이미지"> </a>
						{{/if}}
				...
				<div class="info_area">
					<div class="review_info">
						<span class="grade"><b>{{reviewGrade}}</b></span> <span class="name">{{reviewer}}</span> <span class="date">{{reviewDate}} 방문</span>
					</div>
				</div>
			</div>
		</li>
	</script>
	<script type="rv-template" id="infoBox">
	<div class="box_store_info no_topline">
		<a class="store_location" title="지도웹으로 연결">
		  <img class="store_map img_thumb" alt="map" src="{{mapSrc}}">
			...
			<div class="lst_store_info_wrap">
				<ul class="lst_store_info">
					<li class="item">
					  ...
					  <span class="item_rt"> <a class="store_tel">{{tel}}</a></span>
					</li>
				</ul>
			</div>
		</div>
