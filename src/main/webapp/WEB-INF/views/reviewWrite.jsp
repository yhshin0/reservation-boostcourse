		...
		<div class="ct">
			<div class="ct_wrap">
				<div class="top_title review_header">
					<a href="./myreservation?reservationEmail=${reservationEmail }" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						...
						<input type="file" class="hidden_input" id="reviewImageFileOpenInput" name="attachedImage" accept="image/png, image/jpeg">
						...
						<div class="item_preview_thumbs">
							<ul class="lst_thumb">
								<li class="item" style="display: none;">
									...
									<img src="" width="130" alt="첨부 파일 썸네일" class="item_thumb">
